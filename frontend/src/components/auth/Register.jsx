...
export const Register = () => {
  ...
  // Step management (1 = Account Info, 2 = Palkhi Info for Palkhi Pramukhs)
  ...
  // Step 1: Account Registration / Next Step handler
  ...
  // Step 2: Palkhi Registration (Atomic User + Palkhi creation)
      ...
      <div className="max-w-4xl w-full bg-white rounded-3xl shadow-xl overflow-hidden flex flex-col md:flex-row border border-[#E8D9C3]">
        ...
        <div className="md:w-7/12 p-6 sm:p-8 lg:p-10 flex flex-col justify-center">
          ...
          {step === 2 && (
            <>
              <div className="mb-5">
                <h2 className="text-2xl font-bold text-[#2B1B12]">Register Your Palkhi</h2>
              ...
              <form onSubmit={handlePalkhiSubmit} className="space-y-5">
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full bg-[#DD6B35] hover:bg-[#C85A28] text-white font-bold py-3 px-5 rounded-xl shadow-md shadow-[#DD6B35]/20 focus:outline-none focus:ring-2 focus:ring-[#DD6B35]/40 transition flex items-center justify-center gap-2 disabled:opacity-60 cursor-pointer text-sm"
                >
                  {loading ? (
                    <>
                      <FaSpinner className="animate-spin text-sm" />
          ...
          <p className="text-center mt-6 text-xs text-[#4A392E]/65 md:hidden">
            {step === 1 ? (
              ...
              <button onClick={goBack} className="text-[#DD6B35] font-bold hover:underline">
                ← Back
              </button>
            )}
          </p>
